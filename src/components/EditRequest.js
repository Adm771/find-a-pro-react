...
const EditRequest = () => {
    ...
    const {requestById, getRequestById, editRequest} = useContext(RequestContext);
    ...
    const[serviceCategoryId, setServiceCategoryId]=React.useState(requestById.serviceCategoryId)
  ...
  const onSubmit = (e) => {
      ...
      const editedRequest={title : title, payment : payment, description : description, 
        serviceCategoryId : serviceCategoryId, postCode : postCode, daySlot : daySlot, 
  ...
  return (
    <div id="editRequest" className="container">
        ...
        <div className='form-control'>
              ...
              value={requestById.title} onChange={(e) => setTitle(e.target.value)} 
              />
          </div>
          <div className='form-control'>
          ...
          <div className='form-control'>
              <input type="date" 
              placeholder='Set day' 
              value={requestById.daySlot} onChange={(e) => setDaySlot(e.target.value)} 
              />
          </div>
          <div className='form-control'>
              <input type="time" 
              placeholder='Set time' 
              value={requestById.timeSlot} onChange={(e) => setTimeSlot(e.target.value)} 
              />
          </div>
          <div className='form-control'>
              <input type="number" 
              placeholder='Set max salary rate' 
              value={requestById.payment} onChange={(e) => setPayment(e.target.value)} 
              />
          </div>
          <div className='form-control'>
              <input type="text" 
              placeholder='Set post code' 
              value={requestById.postCode} onChange={(e) => setPostCode(e.target.value)} 
              />
          </div>
          <div>
              <textarea type="textarea" 
              placeholder='Task description' 
              value={requestById.description} onChange={(e) => setDescription(e.target.value)} 
              />
          </div>
